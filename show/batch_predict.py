...
def process_csv(input_file, output_file, headline_col="headline", desc_col="short_description", model_type="glove"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", help="Model type to use (glove, bert, or first)", default="glove", choices=["glove", "bert", "first"])
    ...
    process_csv(args.input_csv, args.output_csv, args.headline_col, args.desc_col, args.model_type)
